...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $metaData['title'] ?? 'Меблевий майстер' }}</title>
        <meta name="description" content="{{ $metaData['description'] ?? 'Проектую та виготовляю корпусні меблі за індивідуальними замовленнями для дому, офісу та торгових точок. Перетворюю Ваші ідеї на реальність, від ескізу до результату. Сприяю створенню комфорту, затишку та максимальної зручності для Вашого Дому та Бізнесу!' }}">
        ...
        <script type="application/ld+json">
         {
             ...
             "legalName": "Меблевий майстер",
             "url": "https://mebelnyymaster.com.ua/",
             "description": "Проектую та виготовляю корпусні меблі за індивідуальними замовленнями для дому, офісу та торгових точок. Перетворюю Ваші ідеї на реальність, від ескізу до результату. Сприяю створенню комфорту, затишку та максимальної зручності для Вашого Дому та Бізнесу!",
             "foundingDate": "2017",
             "contactPoint": {
                 "@type": "ContactPoint",
