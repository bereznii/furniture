            ...
            <section class="content-block">
                <div class="container text-center">
                    ...
                    <div class="description">
                        <h5>
                            Ароматне, приємне та затишне місце, улюблена кава, солодкі млинці. Тепла довгоочікувана вечеря.<br>
                            Улюблене місце, де збирається вся сім'я. Приємні події, розмови. І просто тиша. Все це чекає на Вас на улюбленій кухні.
                        </h5>
                    </div>
                </div>
            </section>
