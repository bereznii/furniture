            ...
            <section class="content-block">
                <div class="container text-center">
                    ...
                    <div class="description">
                        <h5>
                            Стильний сучасний офіс з комфортом завжди прикрашає якісно продумані меблі. <br>
                            У торгових точках важливо, на яких полицях лежить товар, у якому стилі все продумано,
                            що клієнту було зручно вибрати і залишитися задоволеним.ашає якісно продумані меблі.
                        </h5>
                    </div>
                </div>
            </section>
