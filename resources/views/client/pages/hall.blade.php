            ...
            <section class="content-block">
                <div class="container text-center">
                    ...
                    <div class="description">
                        <h5>
                            Що може тішити так, як порядок у домі. Шафи – це те, що робить наш будинок у повному порядку.
                            Замовивши шафу на свій смак і комфорт, Ви будете радіти, як все компактно та продумано.<br>
                            Передпокій щодня нас проводить посмішкою в дзеркалі і зустрічає ввечері з теплом і запахом улюбленого будинку.
                        </h5>
                    </div>
                </div>
            </section>
